...
def findUnit(x):
    ...
    if chosenCategory == None:
        print(f'{x} is not a valid unit type.')
    
print(f"Please enter the unit you want to convert: ")
unitType = input()
findUnit(unitType)
...
print(f"Please enter the unit you want to convert to from this list of options")
...
if output is not None:
    print(f"\nResult: {unit} {unitType} = {output} {unitConvert}")